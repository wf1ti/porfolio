  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-12 md:py-20">
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">01 — THATS ME XD</p>
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
          BlackRros3
            <br />
            <span className="italic">@wt1ti</span>
          </h2>
        </motion.div>
        ...
        >
          <motion.button
          onClick={() => router.push('https://t.me/Wfit1')}
          data-cursor-hover
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">02 — WHO?</p>
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            TOP
            <br />
            <span className="italic">PROGRAMMER</span>
          </h2>
        </motion.div>
      </motion.div>
